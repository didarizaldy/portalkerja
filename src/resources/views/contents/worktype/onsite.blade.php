    ...
    <div class="row">
      <div class="col d-flex justify-content-center">
        <div class="p-3">
          ...
          <p style="text-align: center">Tipe Pekerjaan : <b style="text-transform: capitalize">{{ $jobtype }}</b></p>
        </div>
      </div>
      <div class="">
                ...
                <a href="{{ route('job-details', $post->slug) }}">
                  <div class="card bg-light d-flex flex-fill">
                    ...
                    <div class="card-body pt-0">
                      <div class="row">
                        <div class="col-7">
                          <h6 class="lead" style="font-size: 18px"><b>{{ $post->companies_name }}</b></h6>
                          ...
                          <p class="text-muted text-sm mt-0 mb-0" style="text-transform: capitalize;"><i
                              class="fas fa-map-marker-alt mr-2" style="color: #800080"></i>{{ $post->worksite_location }}
                          </p>
                          <p class="text-muted text-sm mt-0 mb-0" style="text-transform: capitalize;"><i
