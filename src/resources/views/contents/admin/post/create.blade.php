      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <select class="form-control select2" style="width: 100%" name="graduate" required>
            ...
            <option value="megister">S2 - Megister</option>
        ...
        <div class="form-group">
          ...
          <select class="form-control select2" style="width: 100%" name="experience" required>
            ...
            <option value="fresh_graduate">Lulusan Baru</option>
            <option value="oneyear">1 Tahun</option>
            <option value="twoyear">2 Tahun</option>
            <option value="advanced">Diatas 3 Tahun (Tingkat Profesional)</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="tel" class="form-control" name="quota" placeholder="Kuota Yang Dalam Posisi Ini"
            minlength="1" maxlength="3" pattern=".{1,3}" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
            required>
        </div>
